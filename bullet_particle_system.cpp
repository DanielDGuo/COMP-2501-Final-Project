...
#include "bullet_particle_system.h"
#include <iostream>

namespace game {

	BulletParticleSystem::BulletParticleSystem(const glm::vec3& position, Geometry* geom, Shader* shader, GLuint texture, GameObject* parent)
	...
	void BulletParticleSystem::Update(double delta_time) {
	...
	void BulletParticleSystem::Render(glm::mat4 view_matrix, double current_time) {
