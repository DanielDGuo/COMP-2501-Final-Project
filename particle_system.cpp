...
namespace game {
    ...
    ParticleSystem::ParticleSystem(const glm::vec3& position, Geometry* geom, Shader* shader, GLuint texture, GameObject* parent, int t)
    ...
    void ParticleSystem::Render(glm::mat4 view_matrix, double current_time) {
        ...
        shader_->SetUniform1i("type", type);
        shader_->SetUniform1f("spawnTime", spawnTime);
