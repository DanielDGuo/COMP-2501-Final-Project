...
namespace game {
	...
	ConeParticleSystem::ConeParticleSystem(const glm::vec3& position, Geometry* geom, Shader* shader, GLuint texture, GameObject* parent)
	...
	void ConeParticleSystem::Update(double delta_time) {
	...
	void ConeParticleSystem::Render(glm::mat4 view_matrix, double current_time) {
